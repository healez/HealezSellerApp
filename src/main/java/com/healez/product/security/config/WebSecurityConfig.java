...
import com.healez.product.security.security.RestAuthenticationEntryPoint;
import com.healez.product.security.security.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and().exceptionHandling()
				...
				.antMatchers(HttpMethod.GET,"getEncryptedPassword", "/", "/auth/**", "/webjars/**", "/*.html", "/favicon.ico", "/**/*.html",
						"/**/*.css", "/**/*.js")
